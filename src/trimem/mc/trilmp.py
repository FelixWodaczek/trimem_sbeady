...
# using specific packages and the additional pair_styles nonreciprocal         #
# and nonreciprocal/omp (see SETUP_GUIDE.txt for details)                      #
#                                                                              #
...
#   - thermal_velocities=False, langevin_thermostat=True, pure_MD=True         #
# To perform HMC simulation as in Trimem:                                      #
#   - thermal_velocities=True, langevin_thermostat=False, pure_MD=False)       #
################################################################################
...
class TriLmp():
    ...
    def run(
        ...
        - N : number of program (MC+MD) steps
